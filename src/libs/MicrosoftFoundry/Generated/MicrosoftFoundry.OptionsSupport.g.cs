...
namespace MicrosoftFoundry
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::MicrosoftFoundry.AutoSDKRetryOptions Retry { get; set; } = new global::MicrosoftFoundry.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::MicrosoftFoundry.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::MicrosoftFoundry.IAutoSDKHook>();
        ...
        public global::MicrosoftFoundry.AutoSDKClientOptions AddHook(
            global::MicrosoftFoundry.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::MicrosoftFoundry.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::MicrosoftFoundry.AutoSDKClientOptions UseAuthorizationProvider(
            global::MicrosoftFoundry.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::MicrosoftFoundry.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::MicrosoftFoundry.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::MicrosoftFoundry.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::MicrosoftFoundry.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::MicrosoftFoundry.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::MicrosoftFoundry.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::MicrosoftFoundry.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::MicrosoftFoundry.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::MicrosoftFoundry.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::MicrosoftFoundry.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::MicrosoftFoundry.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::MicrosoftFoundry.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::MicrosoftFoundry.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::MicrosoftFoundry.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::MicrosoftFoundry.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::MicrosoftFoundry.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::MicrosoftFoundry.AutoSDKClientOptions clientOptions,
            global::MicrosoftFoundry.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::MicrosoftFoundry.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::MicrosoftFoundry.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::MicrosoftFoundry.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::MicrosoftFoundry.AutoSDKClientOptions clientOptions,
            global::System.Func<global::MicrosoftFoundry.IAutoSDKHook, global::MicrosoftFoundry.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::MicrosoftFoundry.AutoSDKHookContext context)
        {
