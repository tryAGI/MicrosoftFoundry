...
The MicrosoftFoundry SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package MicrosoftFoundry
```
...
using var client = new MicrosoftFoundryClient(
    apiKey: Environment.GetEnvironmentVariable("MICROSOFTFOUNDRY_API_KEY")!);
